...
def _personal_actions(
    *,
    ...
    lines: List[str] = [
        ...
        "  6  ประวัติ / Log",
        "---",
        "  7 / U  คลังทีม          แชร์ user+pass · เกียร์/ยา/เงิน",
        "  8  ตั้งค่า/เซฟ    J  ภารกิจ    9  เงิน·ห้องสมุด",
        "---",
        "  0  กลับ",
    ]
...
def _combat_actions(
    ...
    lines: List[str] = [
        ...
        " อื่น ๆ",
        "  4  หนี",
        "  7  เจรจา soft (บางศัตรู)",
        "---",
        " Auto Play",
        "  8 / A   Continuous หรือ Step + สรุปไฟต์",
        "---",
        " ลัดฟรี   I ประเมิน   ·   3 ยา",
        "        Continuous รันจนจบ · Step=Enter · แพ้=Soft Death",
    ]
